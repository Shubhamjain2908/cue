...
- **Prices:** **Massive.com** REST (env **`POLYGON_API_KEY`**). Today: **per-ticker** aggs in **`massive-price-ingestor.ts`**. **Grouped daily** fetch to cut call count is **Phase 4 scaling (S4)** — see **`project-spec` §12**.
