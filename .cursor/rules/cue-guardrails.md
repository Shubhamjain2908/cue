...
| **Quality-GARP standalone screen: CLOSED** | Factor falsified on NDX100 2023–2025 (Sharpe=-0.891, Expectancy=-0.332%). Do not reopen as standalone screener. Any quality-filter variant requires a new backtest spec and gate clearance before production code. |
